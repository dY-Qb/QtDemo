...
//    design-light.creatortheme
//    design.creatortheme
//    flat-dark.creatortheme
//    flat-light.creatortheme
//    flat.creatortheme
    QSettings appSettings;
    QString themeName = GLOBAL_GET(SettingServer::ePIXEL_IDE_CURRENT_THEME, "Flat Dark").toString();
    setCurrentText(appSettings.value(themeNameKey, themeName).toString());
