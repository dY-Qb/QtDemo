...
const Icon TEMPERATURE_TOOLBAR({
        {QLatin1String(":/utils/images/temperature.png"), Theme::IconsBaseColor}});

const Icon SHARDING_TOOLBAR({
        {QLatin1String(":/utils/images/sharding.png"), Theme::IconsBaseColor}});
...
const Icon FORMAT_TOOLBAR({
    {QLatin1String(":/utils/images/format.png"), Theme::IconsBaseColor}});
...
const Icon GOTO_FOLDER({
        {QLatin1String(":/utils/images/goto_folder.png"), Theme::IconsBaseColor}});
...
const Icon NEWWINDOW_TOOLBAR({
        {QLatin1String(":/utils/images/new_window.png"), Theme::IconsBaseColor}});
...
const Icon STOP({
        {QLatin1String(":/utils/images/stop.png"), Theme::PanelTextColorMid}}, Icon::Tint);
const Icon STOP_TOOLBAR({
        {QLatin1String(":/utils/images/stop.png"), Theme::IconsBaseColor}});
...
const Icon EDIT_TOOLBAR({
        {QLatin1String(":/utils/images/edit.png"), Theme::IconsBaseColor}});
...
const Icon PAUSE_TOOLBAR({
        {QLatin1String(":/utils/images/pause.png"), Theme::IconsModeEditActiveColor}});
const Icon PAUSE_SMALL_TOOLBAR({
        {QLatin1String(":/utils/images/pause.png"), Theme::IconsModeEditActiveColor}});
...
const Icon PROGRESSINDICATOR_SMALL({
        {QLatin1String(":/utils/images/progressindicator_small.png"), Theme::ProgressBarColorNormal}}, Icon::MenuTintedStyle);
const Icon PROGRESSINDICATOR_SMALL_TOOLBAR({
        {QLatin1String(":/utils/images/progressindicator_small.png"), Theme::ProgressBarColorNormal}});
