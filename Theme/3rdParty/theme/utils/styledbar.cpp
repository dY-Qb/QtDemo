...
ThemeHorizonSeparator::ThemeHorizonSeparator(QWidget *parent)
    : QFrame(parent)
{
...
void ThemeHorizonSeparator::paintEvent(QPaintEvent *event)
{
    QPainter painter(this);
    const QColor color = Utils::creatorTheme()->color(Utils::Theme::FancyToolBarSeparatorColor);
    painter.fillRect(event->rect(), color);
}

ThemeVerticalSeparator::ThemeVerticalSeparator(QWidget *parent)
    : QFrame(parent)
{
...
void ThemeVerticalSeparator::paintEvent(QPaintEvent *event)
{
    QPainter painter(this);
    const QColor color = Utils::creatorTheme()->color(Utils::Theme::FancyToolBarSeparatorColor);
    painter.fillRect(event->rect(), color);
