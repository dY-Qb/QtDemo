...
class QTCREATOR_UTILS_EXPORT ThemeHorizonSeparator : public QFrame
{
    Q_OBJECT
public:
    ThemeHorizonSeparator(QWidget *parent = nullptr);
protected:
    void paintEvent(QPaintEvent *event) override;

};

class QTCREATOR_UTILS_EXPORT ThemeVerticalSeparator : public QFrame
{
    Q_OBJECT
public:
    ThemeVerticalSeparator(QWidget *parent = nullptr);
protected:
    void paintEvent(QPaintEvent *event) override;
};
} // Utils