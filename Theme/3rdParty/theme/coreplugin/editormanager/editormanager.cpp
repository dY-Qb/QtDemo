...
EditorManagerPrivate::EditorManagerPrivate(QObject *parent) :
    ...
    m_openGraphicalShellAction(new QAction(/*FileUtils::msgGraphicalShellAction()*/"TODO", this)),
    m_openGraphicalShellContextAction(new QAction(/*FileUtils::msgGraphicalShellAction()*/"TODO", this)),
    m_openTerminalAction(new QAction(/*FileUtils::msgTerminalHereAction()*/"TODO", this)),
    m_findInDirectoryAction(new QAction(/*FileUtils::msgFindInDirectory()*/"TODO", this)),
